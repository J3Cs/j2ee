...
import com.j3cs.test.controller.util.JsfUtil;
import com.j3cs.test.controller.util.PaginationHelper;
...
public class AutorController implements Serializable {
    ...
    @EJB
    private com.j3cs.test.controller.AutorFacade ejbFacade;
    ...
    public Autor getAutor(java.math.BigDecimal id) {
